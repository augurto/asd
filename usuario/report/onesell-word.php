...
$table2->addCell()->addText("S/".number_format($product->price_out,2,".",","));
$table2->addCell()->addText("S/".number_format($operation->q*$product->price_out,2,".",","));
$total+=$operation->q*$product->price_out;
}

$section1->addText("");
$section1->addText("Total: S/ ".number_format($total,2,".",","),array("size"=>20));
