...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Polleria | Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>Polleria</b>...</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="">
                      <a href="#"  class="">Referenciar 1</a>
                      <a href="#"  class="">Referenciar 2</a>
                  </li>
...
<div class="user-panel">
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Copyright &copy; <?php echo date("Y"); ?> <a href="#" >Polleria</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
        <a href="./">Polleria<b>...</b></a>
      </div><!-- /.login-logo -->
