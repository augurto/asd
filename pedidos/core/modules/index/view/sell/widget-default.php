...
<!--
	<select class="form-control" id="mesero" name="mesero_id" required>
		...
		-->
			<input type="hidden" class="form-control" id="mesero" name="mesero_id" required value="7">
			<input type="text" class="form-control" id="mesero_muestra" name="mesero_id_muestra" required value="chesse">
